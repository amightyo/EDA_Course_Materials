...
```{r}
subset(mtcars, qsec<=0.25 | qsec==16.9)
```
...
Once you have the answer, go the [Udacity website](https://www.udacity.com/course/viewer#!/c-ud651/l-729069797/e-804129319/m-811719066 "Udacious with R") to continue with Lesson 2.
